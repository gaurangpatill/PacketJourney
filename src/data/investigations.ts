...
const redirects = investigationSchema.parse({
  ...
  stages: [
    ...
    stage({
      ...
      type: "edge",
      title: "Final URL",
      shortTitle: "Final URL",
      description: "The canonical locale URL returns the final document response.",
      duration: 18,
      next: ["origin"],
      evidence: [
        { label: "URL", value: "https://www.example.com/en-us/shop" },
...
const slowOrigin = investigationSchema.parse({
  ...
  stages: [
    ...
    stage({
      id: "edge-return",
      type: "edge",
      title: "Edge response relay",
      shortTitle: "Edge return",
      description: "The origin response returns through the edge to the browser.",
      duration: 12,
      next: ["browser"],
      evidence: [
        { label: "Colo", value: "EWR" },
        { label: "Direction", value: "Origin to client" },
      ],
    }),
    stage({
      id: "browser",
...
const thirdParty = investigationSchema.parse({
  ...
  stages: [
    ...
    stage({
      ...
      duration: 72,
      next: ["content", "analytics", "ads", "chat", "fonts", "scripts", "images"],
    ...
    stage({
      ...
      shortTitle: "Fonts",
      description: "Web fonts load from an external font delivery service.",
      duration: 384,
      branch: 4,
      next: ["render"],
      evidence: [
        { label: "Domain", value: "fonts.example-cdn.com" },
        { label: "Resource type", value: "Font" },
        { label: "Classification", value: "Font CDN", confidence: "inferred" },
      ],
    }),
    stage({
      id: "scripts",
      ...
      shortTitle: "Scripts",
      description: "First-party JavaScript bundles load and execute.",
      duration: 642,
      branch: 5,
      next: ["render"],
      evidence: [
        { label: "Resource type", value: "Script" },
        { label: "Transfer", value: "612 KB" },
      ],
    }),
    stage({
      id: "images",
      ...
      shortTitle: "Images",
      description: "Article images load through an external image CDN.",
      duration: 526,
      branch: 6,
      next: ["render"],
      evidence: [
        { label: "Domain", value: "images.example-cdn.com" },
        { label: "Resource type", value: "Image" },
        { label: "Classification", value: "Image CDN", confidence: "inferred" },
      ],
    }),
    stage({
      id: "render",
...
const missingCache = investigationSchema.parse({
  ...
  stages: [
    ...
    stage({
      ...
      title: "Edge response relay",
      shortTitle: "Edge return",
      description: "The uncached origin response returns through the edge.",
      duration: 10,
      next: ["browser"],
      evidence: [{ label: "Direction", value: "Origin to client" }],
    }),
    stage({
      id: "browser",
      type: "browser",
